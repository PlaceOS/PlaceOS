...
- Clients/Typescript [**realtime**]: Add timeout to requests
- Clients/Typescript [**realtime**]: Prevent bind/unbind from expiring
- Interfaces/Templates [**workplace**]: Fix end date values for limiting user date selection (ppt-971)
- Interfaces/Templates [**concierge**]: Tweaks to displaying events on day view timeline
- Interfaces/Templates [**events**]: Fix duration for multi-day bookings
- Interfaces/Templates [**concierge**]: Fix checkin for guests
...
- Interfaces/Templates [**visitor-kiosk**]: Fix checkin
- Interfaces/Templates: Remove end date from outlook calendar links
...
- Interfaces/Templates [**visitor-kiosk**]: Use map-kiosk logic for map view
- Interfaces/Templates: Remove title attribute from custom table cells (ppt-979)
- Interfaces/Templates: Allow user to select text in chat
- Interfaces/Templates: Fix defaulting all day to true
- Interfaces/Templates [**concierge**]: Tweaks to printing qr codes (ppt-952)
...
- Interfaces/Templates: Various minor fixes for all day related logic
...
- Interfaces/Templates [**visitor-kiosk**]: Disable preferences for now
- Interfaces/Templates [**concierge**]: Fix checkin of visitors
...
- Interfaces/Templates [**events**]: Change setup/breakdown time back to minutes
...
- Interfaces/Templates [**bookings**]: Display desks without a user as not-bookable
- Interfaces/Templates [**assets**]: Tweak saving/updating of linked asset bookings
- Interfaces/Templates [**bookings**]: Fix map colours on desk select modal (ppt-913)
- Interfaces/Templates [**bookings**]: Hide check-in after check on details modal
- Interfaces/Templates [**concierge**]: Fix colour of desk check-in button
- Libraries/Driver [**interface/chat_functions**]: Simplify function_schemas
- Libraries/Driver [**interface/chat_functions**]: Include description with function schema
- Libraries/Driver [**transport**]: Http helper method selection
- Libraries/Driver [**transport**]: Http helper method selection
- Libraries/Driver [**proxy/subscriptions**]: Ensure it functions standalone
- Libraries/Models [**event_metadata**]: Change setup_event_id and breakdown_event_id data type in db ([#233](https://github.com/PlaceOS/placeos-models/pull/233))
- Libraries/Models: Migration order due to commit merge
- Services/Init [**shard.lock**]: Bump migrations
...
- Interfaces/Templates: Add ability to manage booking rules for rooms and desks
- Interfaces/Templates: Add setting to default all day to true (ppt-964)
- Interfaces/Templates: Simplify all day logic (ppt-962)
- Interfaces/Templates: Add chat assistant integrations and ui
- Interfaces/Templates [**events**]: Update logic for setup and breakdown
...
- Libraries/Driver [**interface/chat_functions**]: Use annotations for simpler drivers
- Libraries/Driver: Expose driver interface to drivers
- Libraries/Driver [**interface/chat_functions**]: Expose data via redis
- Libraries/Driver [**transport/http**]: Add some debug
...
- Services/RestAPI [**chat_gpt**]: Update prompt with users details
- Services/RestAPI [**chat_gpt/chat_manager**]: Migrate to using status where possible
- Services/RestAPI [**chat_gpt**]: Provides the current date and time with each request
- Services/SearchIngest [**shard.lock**]: Bump models
- Services/StaffAPI [**events**]: Add fields to patch event metadata
