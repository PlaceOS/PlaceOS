...
- Clients/Typescript [**metadata**]: Cleanup request for metadata history
...
- Interfaces/Templates [**assets**]: Fix checking rules
...
- Interfaces/Templates [**workplace**]: Fix display of level/building on parking/locker success view
- Interfaces/Templates [**bookings**]: Fix resource locations when editing bookings (ppt-1876)
- Interfaces/Templates [**concierge**]: Fix admin check logic
- Interfaces/Templates [**concierge**]: Use the assigned users plate number when creating booking (ppt-1879)
- Interfaces/Templates [**concierge**]: Fix saving app settings with a top level array
...
- Interfaces/Templates: Add individual settings for all_day_default (ppt-1887)
...
- Interfaces/Templates [**visitor-kiosk**]: Fix handling of check-in errors
...
- Interfaces/Templates [**bookings**]: Prevent paginated requests causing an infinite loop
- Interfaces/Templates [**catering**]: Fix managing charge codes
- Interfaces/Templates [**catering**]: Fix importing item options
- Interfaces/Templates [**visitor-kiosk**]: Fix saving visitor data changes
- Interfaces/Templates [**workplace**]: Ignore charge code check when none available
- Libraries/Driver [**protocol/management**]: Ensure driver load success ([#168](https://github.com/PlaceOS/placeos-driver/pull/168))
- Libraries/Driver [**protocol/management**]: Process wait can raise if process shutdown
- Libraries/Driver [**specs/runner**]: Missed new zone list
...
- Services/StaffAPI [**bookings**]: Error message when type param missing
...
- Interfaces/Templates [**workplace**]: Add setting to only allow selecting locker durations
...
- Interfaces/Templates [**concierge**]: Add more information when saving app settings
- Libraries/Driver [**driver-specs/runner**]: Add zones and timezone
...
- Services/RestAPI [**websocket/session**]: Allow privalege escalation
...
- Interfaces/Templates [**events**]: Refactor events form service
- Swagger/RestAPI: Update for placeos-2.2502.2
- Swagger/StaffAPI: Update for placeos-2.2502.2
