...
- Interfaces/Backoffice [**admin**]: Signage ai providers page
- Interfaces/Backoffice [**repositories**]: Add interface changelog tab
- Interfaces/Backoffice: Reduce app bundles and defer optional downloads
- Interfaces/Backoffice: Reduce repeated work and virtualize domain users
- Interfaces/Templates [**signage-manager**]: Create and edit signage artwork with ai
- Interfaces/Templates [**mocks**]: Signage ai endpoints
- Interfaces/Templates [**signage-manager**]: Name the engine behind the images
- Interfaces/Templates [**signage-manager**]: Change an existing image with ai
- Interfaces/Templates [**signage-manager**]: Show the image being changed
- Interfaces/Templates [**signage-manager**]: As many blocks of text as the poster needs
- Interfaces/Templates [**signage-manager**]: Let a logo be added, since nothing stores one
- Interfaces/Templates [**signage-manager**]: A branding page for the organisation
- Interfaces/Templates [**signage-manager**]: Full screen ai modal, preview left, settings right
- Interfaces/Templates [**signage-manager**]: A light and a dark logo, and words you drag
- Interfaces/Templates [**signage-manager**]: Paragraphs, and any colour or face per block
- Interfaces/Templates [**signage-manager**]: Attach images to a request and name them in the brief
- Interfaces/Templates [**signage-manager**]: A switch for whether the poster wears the branding
- Interfaces/Templates [**signage-manager**]: Branding is read only unless you are a sys admin
- Interfaces/Templates [**signage**]: Revalidate display polls with etags
- Interfaces/Templates [**signage-manager**]: Separate images to include from the style reference
- Interfaces/Templates [**signage-manager**]: Show source zone for template mappings
- Interfaces/Templates [**common**]: Log service worker status
- Interfaces/Templates [**ci**]: Keep matrix checkouts shallow
- Interfaces/Templates: Reduce runtime and bundle overhead
- Interfaces/Templates: Reduce initial application bundles
- Interfaces/Templates [**form-fields**]: Add optional end-time entry for durations
- Interfaces/Templates [**signage-manager**]: Show templates in display schedules
- Interfaces/Templates [**workplace**]: Require visitor reason by setting (ppt-2782)
...
- Interfaces/Backoffice [**admin**]: Send a cleared provider field as empty, not null
- Interfaces/Backoffice [**admin**]: Signage ai provider tab defects
- Interfaces/Backoffice [**admin**]: Harden signage ai provider setup
- Interfaces/Backoffice [**admin**]: Unify header actions and fix signage ai table overflow
- Interfaces/Backoffice [**admin**]: Fix close button on view upload modal
- Interfaces/Templates [**signage-manager**]: Brand kit, layer layout and the save race
- Interfaces/Templates [**signage-manager**]: Do not stack ai dialogs
- Interfaces/Templates [**signage-manager**]: Drop the creation-only options from an edit
- Interfaces/Templates [**signage-manager**]: Drop the shape selector from an edit
- Interfaces/Templates [**signage-manager**]: One gutter around the playlists panel
- Interfaces/Templates [**signage-manager**]: One height across the media toolbar
- Interfaces/Templates [**signage-manager**]: The frontend defects found in the pre-push audit
- Interfaces/Templates [**signage-manager**]: Let tab out of the canvas, and keep the key across dialogs
- Interfaces/Templates [**signage-manager**]: Harden ai image jobs
- Interfaces/Templates [**signage-manager**]: Restore recent ai jobs
- Interfaces/Templates [**signage-manager**]: Enforce ai action capabilities
- Interfaces/Templates [**visitor-kiosk**]: Retain accepted induction status ppt-2763
- Interfaces/Templates [**concierge**]: Connect survey save action ppt-2746
- Interfaces/Templates [**concierge**]: Remove deleted asset from list ppt-2747
- Interfaces/Templates [**concierge**]: Repair bulk asset endpoint ppt-2748
- Interfaces/Templates [**build**]: Repair build and serve commands
- Interfaces/Templates [**visitor-kiosk**]: Improve qr code scanning
- Interfaces/Templates [**assets**]: Restrict selection for disabled rooms ppt-2745
- Interfaces/Templates [**bookings**]: Use stored period for group edits ppt-2740
- Interfaces/Templates [**signage-manager**]: Tweak display templates zone link
- Interfaces/Templates [**signage**]: Correct player display styling
- Interfaces/Templates [**common**]: Recover stalled zone loading
- Interfaces/Templates [**ci**]: Repair affected app builds
- Interfaces/Templates [**apps**]: Load deployed changelogs
- Interfaces/Templates: Prevent app initialisation from stalling
- Interfaces/Templates: Complete missing user interface behaviour
- Interfaces/Templates [**concierge**]: Hide cancellation for active meetings (ppt-2629)
- Interfaces/Templates [**bookings**]: Remove visitors from linked attendees (ppt-2697)
- Interfaces/Templates [**signage**]: Recover playback when the media cache is broken
- Interfaces/Templates [**ci**]: Keep changelog failures from blocking builds
- Interfaces/Templates [**bookings**]: Block actions on cancelled bookings (ppt-2768)
- Interfaces/Templates [**concierge**]: Restrict emergency role creation (ppt-2750)
- Interfaces/Templates [**styles**]: Restore tailwind utility selector specificity
- Interfaces/Templates [**signage-manager**]: Show tab count badges and loading states
- Interfaces/Templates [**signage**]: Keep playing from cache while offline
- Interfaces/Templates [**workplace**]: Clarify pending room bookings (ppt-2781)
- Interfaces/Templates [**explore**]: Respect meeting privacy settings (ppt-2784)
- Interfaces/Templates [**concierge**]: Group parking no-shows by user (ppt-2783)
...
- Services/Auth.cr [**oauth**]: Include created_at in token responses
- Services/Auth.cr [**oauth**]: Include created_at in token responses ([#36](https://github.com/PlaceOS/auth.cr/pull/36))

### Changed

- Interfaces/Backoffice [**admin**]: Remove the state left behind the signage ai domain picker
- Interfaces/Backoffice [**admin**]: Bring the signage ai page in line with the repo
- Interfaces/Backoffice: Remove unused code and low-value tests
- Interfaces/Templates [**signage-manager**]: Clean up ai support code
- Interfaces/Templates: Remove redundant tests and wrappers
- Swagger/RestAPI: Update for placeos-2.2609.1
- Swagger/StaffAPI: Update for placeos-2.2609.1
