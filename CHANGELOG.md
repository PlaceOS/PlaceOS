...
- Libraries/LogBackend: Use only one signal (USR1) to toggle between log levels
- Services/RestAPI [**webhook**]: Add additional routes ([#293](https://github.com/PlaceOS/rest-api/pull/293))

### Fixed

- Interfaces/Backoffice [**ui**]: Set max height for upload list component list ([#273](https://github.com/PlaceOS/backoffice/pull/273))
...
- Interfaces/Templates [**events**]: Tweak event form
...
- Libraries/Driver: Re-establish signal registration once executed
- Services/Core [**control_system_modules**]: Update system references in modules ([#215](https://github.com/PlaceOS/core/pull/215))
- Services/RestAPI [**websocket**]: Close `write_channel` on cleanup, resolves a latent memory leak ([#291](https://github.com/PlaceOS/rest-api/pull/291))
