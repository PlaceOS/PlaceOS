...
- Interfaces/Backoffice [**admin**]: Make scope required for api keys
- Interfaces/Backoffice [**admin**]: Fix to validator changes for tenant delegation
- Interfaces/Backoffice [**admin**]: Tweak tenant form
- Interfaces/Backoffice [**admin**]: Tweak outlook tenant config
- Interfaces/Backoffice [**admin**]: Tweaks to tenant form
- Interfaces/Backoffice [**admin**]: Tweak tenant form
- Interfaces/Backoffice: Tweak item sidebar size
- Interfaces/Backoffice [**admin**]: Tweak editing of tenants
- Interfaces/Templates [**spaces**]: Tweak listing of spaces features for filtering
- Interfaces/Templates [**workplace**]: Fix dark mode styles for booking success pages
- Interfaces/Templates [**bookings**]: Tweak feature display for desk details
- Interfaces/Templates [**bookings**]: Fix image display on desk list
- Interfaces/Templates: Fix build errors
- Interfaces/Templates [**common**]: Fix calendar link generation
- Interfaces/Templates [**common**]: Fix to previous commit
- Interfaces/Templates [**workplace**]: Add calendar links to desk success view
- Interfaces/Templates [**bookings**]: Fix parsing asset name
- Interfaces/Templates [**common**]: Fix calendar links for google calendar
- Interfaces/Templates [**common**]: Fix timezone issue with calendar links
- Interfaces/Templates [**concierge**]: Update handling of visitor data
- Interfaces/Templates [**common**]: Tweak handling of attendees for calendar links
- Interfaces/Templates [**concierge**]: Fix dark mode styles for concierge
- Interfaces/Templates [**concierge**]: Aggregate space data based off email rather than id
- Interfaces/Templates [**concierge**]: Fix to previous commit
- Interfaces/Templates [**booking-panel**]: Add dark mode to bootstrap view
- Interfaces/Templates [**workplace**]: Add loader to landing space availability display
- Interfaces/Templates [**events**]: Prevent editing/deleting when unavailable
- Interfaces/Templates [**events**]: Fix dates in calendar links
- Interfaces/Templates [**form-fields**]: Fix updating of space list on modal close
- Interfaces/Templates [**concierge**]: Tweak display of space report data
- Interfaces/Templates [**concierge**]: Tweak handling of space data
- Interfaces/Templates [**spaces**]: Fix error when searching for spaces
- Interfaces/Templates [**bookings**]: Tweak handling of booking type
- Interfaces/Templates [**bookings**]: Fix making visitor bookings
- Interfaces/Templates [**bookings**]: Fix to previous commit
- Interfaces/Templates [**workplace**]: Fix visitor flow not returning to home after finished
- Interfaces/Templates: More visitor fixes
- Interfaces/Templates [**bookings**]: Add error handling to invite visitor
- Interfaces/Templates [**outlook-addin**]: Fix desk success view
- Interfaces/Templates [**events**]: Fix to converting visitor booking into event
- Interfaces/Templates [**events**]: Fix overflow on notes
- Interfaces/Templates [**concierge**]: Fix rendering of space report table
- Interfaces/Templates [**concierge**]: Fix space listing on space report
- Interfaces/Templates [**bookings**]: Tweak to visitor listing
...
- Interfaces/Templates [**events**]: Fix converting bookings to events
- Interfaces/Templates [**events**]: Fix loading space data for details modal
- Interfaces/Templates [**event**]: Fix dark mode styles
- Interfaces/Templates [**spaces**]: Tweak space pipe retrieving data
- Interfaces/Templates [**concierge**]: Fix displaying of attendance data
- Interfaces/Templates [**concierge**]: Ignore spaces without valid details on space report
- Interfaces/Templates [**bookings**]: Fix visitor name being stored
- Interfaces/Templates [**bookings**]: Show different error message for visitor bookings
- Interfaces/Templates [**bookings**]: Tweak to payments
- Interfaces/Templates [**control**]: Fix marked usage
- Interfaces/Templates [**calendar**]: Only load calendars when needed
- Interfaces/Templates [**events**]: Pass selected rooms as attendees
- Interfaces/Templates [**concierge**]: Add logic to checkin guests from placeos bookings
- Interfaces/Templates [**concierge**]: Fix rooms being counted twice for reports
- Interfaces/Templates [**workplace**]: Add logic for checking in resources to qr code view
- Libraries/Driver [**driver-specs/runner**]: Require yaml
...
- Libraries/Models: Docker-compose file entry for shard.yml.input ([#187](https://github.com/PlaceOS/placeos-models/pull/187))
...
- Interfaces/Backoffice [**admin**]: Add outlook config to tenant
- Interfaces/Templates [**workplace**]: Add calendar links to desk booking
...
- Interfaces/Templates: Allow restriction of multiple space/desk/parking selection
- Interfaces/Templates [**concierge**]: Display people count data on space report
...
- Interfaces/Templates [**bookings**]: Add simple lookup for past visitors
- Interfaces/Templates [**bookings**]: Add attendees key to bookings
...
- Libraries/LogBackend: Add support for crystal 1.6
...
- Interfaces/Templates [**styles**]: Cleanup global styles
- Services/Auth [**deps**]: Bump nokogiri from 1.13.8 to 1.13.9 ([#87](https://github.com/PlaceOS/auth/pull/87))
- Services/Auth [**deps**]: Bump google-protobuf from 3.21.6 to 3.21.7 ([#85](https://github.com/PlaceOS/auth/pull/85))
