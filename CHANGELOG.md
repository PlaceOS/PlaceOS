...
- Clients/Typescript [**auth**]: Scope api keys to client application
- Clients/Typescript: Fix to previous commit
- Interfaces/Backoffice: Sort metadata listing by key name
...
- Interfaces/Templates: Tweaks to locate search of maps indoors
- Interfaces/Templates [**booking**]: Fix wording of clash booking error message
- Interfaces/Templates [**explore**]: Change sensor overlay to tooltip
- Interfaces/Templates [**map-kiosk**]: Fix ability to locate spaces from url params
...
- Interfaces/Templates [**workplace**]: Move check for assets and catering availability to a stream
- Interfaces/Templates: Fix maps indoors sizing in modals
- Interfaces/Templates [**events**]: Fix enabling recurrence
...
- Interfaces/Templates [**workplace**]: Fix asset availability checks on meeting form
...
- Interfaces/Templates [**bookings**]: Fix sizing of images
- Interfaces/Templates [**bookings**]: Minor tweak to display of details for group events
- Interfaces/Templates [**form-fields**]: Clear input field after uploading image (ppt-1370)
- Interfaces/Templates [**form-fields**]: Add image viewer component
- Interfaces/Templates [**maps-people**]: Fix setting level from zone (ppt-1376)
- Interfaces/Templates [**concierge**]: Hold report queries over reloads
...
- Interfaces/Templates [**workplace**]: Set desk asset_id to active resource if not set
- Services/Build [**build**]: Change code to use git-repo shard instead of old repository store
- Services/Build_service [**presign_url**]: Monkey patched aws shard to properly respect endpoint setting. fix docker build by adding missing shard
...
- Services/Core [**shard.lock**]: Connectproxy::httpclient class methods ignore proxy
- Services/Edge [**logging**]: Ppt-1368 - logging to use placeos-log-backend ([#271](https://github.com/PlaceOS/edge/pull/271))
- Services/Edge [**driver_manager**]: Should be truncating when recomp driver is retrieved ([#273](https://github.com/PlaceOS/edge/pull/273))
- Services/Edge [**shard.lock**]: Connectproxy::httpclient class methods ignore proxy
...
- Services/StaffAPI [**application**]: Forbidden when no valid scope
...
- Clients/Typescript [**modules**]: Add runtime error endpoint and update model
...
- Interfaces/Templates: Add component for drawing polygons on the map
...
- Interfaces/Templates: Add date range field
- Interfaces/Templates [**concierge**]: Add calendar views for group events
...
- Services/Build: Add env var to disable build service
- Services/Build_service: Ppt-1334 enhanced api and capabilities
