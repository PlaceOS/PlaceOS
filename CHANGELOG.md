...
- Clients/Typescript [**applications**]: Add preserve_client_id field
- Interfaces/Backoffice: Fix dark mode colours for metadata
...
- Interfaces/Backoffice [**drivers**]: Hide update available ui when new commit matches old
- Interfaces/Backoffice [**applications**]: Fix form displaying correct client id
- Interfaces/Backoffice [**drivers**]: Only show drivers with new commits on update list
...
- Interfaces/Templates [**concierge**]: Fix desk report level utilisation graph
- Interfaces/Templates [**workplace**]: Fix check for auto-release (ppt-1155)
- Interfaces/Templates [**assets**]: Prevent re-creating requests when no changes made
- Interfaces/Templates [**events**]: Use linked bookings for assets if available
- Interfaces/Templates [**assets**]: Add internal times to diff check
- Interfaces/Templates [**assets**]: Handle re-creating requests on change rooms
...
- Interfaces/Templates [**assets**]: Prevent selecting end time for asset requests
...
- Interfaces/Templates [**assets**]: Fix check for invalid delivery times
- Interfaces/Templates [**assets**]: Fix handling of clashes on edit (proj-658)
- Interfaces/Templates [**workplace**]: Re-add visitor invite to top menu
- Interfaces/Templates: Fix status of resource on select modals
- Interfaces/Templates [**workplace**]: Ignore cancelled bookings for auto-release check
...
- Interfaces/Templates [**assets**]: Ignore existing bookings for availability checks on edit
- Interfaces/Templates [**assets**]: Fix availability check for validating asset requests
...
- Interfaces/Templates [**concierge**]: Tweak form to correctly set event and booking related settings (ppt-1301)
- Interfaces/Templates [**explore**]: Fix various minor issues
- Interfaces/Templates [**map-kiosk**]: Fix styling (ppt-1239)
- Interfaces/Templates [**explore**]: Fix token for directions on mapbox
- Interfaces/Templates: Fix scoping of systems to a zone
- Interfaces/Templates [**map-kiosk**]: Allow multi-building level options when use_region is set
- Interfaces/Templates [**explore**]: Allow using map_id for zone/area statuses
- Interfaces/Templates [**map-kiosk**]: Prevent websocket bindings when app set as public
- Interfaces/Templates [**explore**]: Fix parsing zone status data
- Interfaces/Templates [**explore**]: Tweak to styling zones/areas
- Interfaces/Templates [**explore**]: Apply at_location to zone status
- Interfaces/Templates [**explore**]: Merge binding data streams for zones
- Interfaces/Templates [**bookings**]: Increase page size for checking resoure availability (ppt-1318)
- Interfaces/Templates [**concierge**]: Disable poi public link if not available
- Interfaces/Templates [**concierge**]: Add ability to set a public url key to poi short links
- Interfaces/Templates [**explore**]: Correctly pass options to mapsindoors component
- Interfaces/Templates [**concierge**]: Update public poi urls
- Interfaces/Templates [**explore**]: Prevent loading parking bookings when ui is public
- Libraries/Driver [**sensor**]: Add level to initializer
- Libraries/Models [**playlist/item**]: Requires authority scope
- Libraries/Models [**migrations**]: Signage migration
- Libraries/Models [**driver**]: Remove flag if commits match ([#257](https://github.com/PlaceOS/placeos-models/pull/257))
- Libraries/Models [**shortener**]: Add some rand and validation
- Services/Core [**driver_manager**]: Interacting with private repo ([#267](https://github.com/PlaceOS/core/pull/267))
- Services/Core [**shard.yml**]: Specify driver version
- Services/Edge [**driver_manager**]: Interacting with private repo ([#267](https://github.com/PlaceOS/edge/pull/267))
- Services/Edge [**shard.yml**]: Specify driver version
- Services/Nginx: Incorrect redirect uri
- Services/RestAPI [**playlist_media**]: Remove media from bucket
- Services/RestAPI [**short_url**]: Svg rendering
- Services/SearchIngest [**config**]: Scope models correctly

### Added

- Interfaces/Backoffice [**admin**]: Add banner and display for tenant secret expiry (ppt-1271)
- Interfaces/Templates: Test
- Interfaces/Templates [**map-kiosk**]: Update design
- Interfaces/Templates [**workplace**]: Allow using regions for resource availability (ppt-1184)
- Interfaces/Templates [**concierge**]: Add setting to customise workplace app settings key
...
- Interfaces/Templates [**concierge**]: Add section for management for urls
- Interfaces/Templates [**concierge**]: Add public link for points of interest
- Libraries/Driver [**interface/sensor**]: Add type modifier
- Libraries/Driver [**redis-storage**]: Expose redis internals
...
- Libraries/Models [**playlist**]: Add helpers for updating metrics
...
- Services/Edge: Integrate build service ([#266](https://github.com/PlaceOS/edge/pull/266))
- Services/Edge: Migrate to redis for service discovery ([#268](https://github.com/PlaceOS/edge/pull/268))
...
- Interfaces/Templates [**explore**]: Re-write mapspeoples integration
- Interfaces/Templates: Tweak map usage through apps
- Services/Core [**deps**]: Bump alstr/todo-to-issue-action from 4.10.1 to 4.10.2 ([#261](https://github.com/PlaceOS/core/pull/261))
- Services/Edge [**deps**]: Bump alstr/todo-to-issue-action from 4.10.1 to 4.10.2 ([#261](https://github.com/PlaceOS/edge/pull/261))
